...
export const NavBar = () => {
  const NavBarJSX = (
    <>
      <nav>
        <div className="nav-wrapper">
          <div className="col s12 kamernet-grey darken-1">
            ...
            <div
              id="mm-hamburger"
              className="hamburger--collapse js-toggle-left-slidebar button-collapse hide-on-large-only"
            >
            ...
            <div className="hide-on-med-and-up badge mobile-message-badge-hamburger">
              {/*@Html.Action("GetUnreadConversationsCount", "Home", new { userId = UserContextHelper.CurrentUser.UserId })*/}
            </div>

            {/* Desktop, Logo and Search (Left) */}
            <ul className="left header-ulist">
              ...
              <li className="search-rooms-menubar hide-on-med-and-down">
                <a href="@NavigationHelper.GetFullRouteUrl(KamernetRoute.Search)">
                  ...
                  @Translator.TranslateText("LBL_HEADER_SEARCH")
                </a>
              </li>
            </ul>
            ...
            <ul className="right hide-on-med-and-down">
              <li className="disable-hover hide-on-med-and-down place-button-container">
                <a
                  href="@NavigationHelper.GetFullRouteUrl(KamernetRoute.CreateRoomAdvertOrCompleteDraft)"
                  className="btn waves-effect waves-light header-ca-button kamernet-orange z-depth-0"
                >
              ...
              <li className="menubar">
                <a
                  href="@_messageUrl"
                  className="message-menubar tooltipped"
              ...
              <li className="menubar">
                <a
                  href="@_favoriteUrl"
                  className="myfavorites-menubar tooltipped"
                  data-position="bottom"
                  data-delay="50"
              ...
              <li className="disable-hover right-menu profile-photo-menubar">
                <img
                  src="@ProfilePhoto"
                  alt=""
                  className="circle valign profile-image "
                />
                <div className="menu_right_icon">
                  <i className="fa fa-bars" aria-hidden="true"></i>
                </div>
                <div className="caret-menubar">
      ...
      {/* Floating menu */}
      <div class="desktop-menu-right hide-on-med-and-down white">
        @Html.Partial("~/Views/Shared/_FloatingDesktopMenu.cshtml")
      </div>
    </>
  );

  return <div>{NavBarJSX}</div>;
};
