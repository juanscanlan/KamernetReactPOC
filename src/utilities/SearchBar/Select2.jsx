      ...
      S2.define(
        ...
        function ($, BaseSelection, Utils, KEYS) {
          ...
          SingleSelection.prototype.render = function () {
            ...
            $selection.html(
              '<span class="select2-selection__rendered" aria-disabled="true" aria-label="' +
                $selection.innerText +
                '"></span>' +
      ...
      S2.define(
        ...
        function (Utils) {
          ...
          Placeholder.prototype.createPlaceholder = function (
            ...
            $placeholder.attr("aria-disabled", true);
          ...
          Search.prototype.render = function (decorated) {
            ...
            var $search = $(
              '<li class="select2-search select2-search--inline">' +
                ...
                ' spellcheck="false" role="searchbox" aria-autocomplete="list" id="' +
                inputId +
                '"/>' +
                '<label for="' +
                inputId +
